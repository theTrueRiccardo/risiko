...
public class ConquistaNordAmericaAfrica implements Obbiettivo{
	
	private String testo = "Devi conquistare Nord America e Africa";
	...
	public boolean eSoddisfatto() {
		...
		return cont1.equals(Risiko.America_Del_Nord) && cont2.equals(Risiko.Africa);
	}
