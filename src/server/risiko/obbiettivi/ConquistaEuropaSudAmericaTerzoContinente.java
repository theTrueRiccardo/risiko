...
public class ConquistaEuropaSudAmericaTerzoContinente implements Obbiettivo{

	private String testo="Devi conquistare Europa, Sud America e un terzo continente a tua scelta";
	...
	public boolean eSoddisfatto() {
		...
		if(!cont1.equals(Risiko.Europa) || !cont2.equals(Risiko.America_Del_Sud))return false;
		...
		cont6.and(Risiko.Oceania);
		return cont3.equals(Risiko.Asia) || cont4.equals(Risiko.Africa) || cont5.equals(Risiko.America_Del_Nord) || cont6.equals(Risiko.Oceania);
