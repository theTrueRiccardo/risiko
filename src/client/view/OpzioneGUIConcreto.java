...
public class OpzioneGUIConcreto implements OpzioneGUI {
	...
	private Controller controllerBottoneColoreArmate;
	private Controller controllerBottoneDado;
	...
	@Override
	public void setControllerBottoneDado(Controller controllerBottoneDado) {
		this.controllerBottoneDado = controllerBottoneDado;
		bottoneDado.addActionListener(controllerBottoneDado);
	}
	...
	@Override
	public void setControllerBottoneColoreArmate(Controller controllerBottoneColoreArmate) {
		this.controllerBottoneColoreArmate=controllerBottoneColoreArmate;
