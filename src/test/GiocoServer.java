...
public class GiocoServer {
	
	static final int numPartecipanti = 1;
	...
	private ArrayList<String> nazioni = new ArrayList<String>(Arrays.asList(new String[] {
	...
	private final int numGiocatori = 1;
	
	private  BitSet vitaGiocatori = new BitSet(numGiocatori);
	
	//(rosso,giallo,verde,blu,nero,viola)
	private  BitSet coloreScelto = new BitSet(6);
	
	private  BitSet Africa = new BitSet(42);
	private  BitSet Oceania = new BitSet(42);
	private  BitSet America_Del_Sud = new BitSet(42);
	private  BitSet America_Del_Nord = new BitSet(42);
	private  BitSet Asia = new BitSet(42);
	private  BitSet Europa = new BitSet(42);
